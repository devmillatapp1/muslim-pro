...
import 'package:muslim/src/features/share_as_image/data/models/share_image_settings.dart';
import 'package:muslim/src/features/share_as_image/data/repository/share_as_image_const.dart';
...
class ShareImageCubit extends Cubit<ShareImageState> {
  ...
  Future _saveDesktop(ByteData? byteData) async {
    ...
    String? outputFile = await FilePicker.platform.saveFile(
      ...
      fileName: 'ElmoslemProSharedImage-$timestamp.png',
    );
  ...
  Future _savePhone(ByteData? byteData) async {
    ...
    final File file =
        await File('${tempDir.path}/ElmoslemProSharedImage.png').create();
