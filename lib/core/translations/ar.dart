const Map<String, String> ar = {
  ...
  // */
  ///
  "Elmoslem Pro App": 'تطبيق المسلم برو',
  "Elmoslem Pro": 'المسلم برو',
  "start": "البدء",

  /// Dashboard
  "index": "الفهرس",
  "favourites content": "المفضلة",
  ...
  "no title with this name": "لا يوجد عنوان بهذا الاسم",
  "please review the index of the book": "برجاء قم بمراجعة فهرس الكتاب",
  ...
  /// About page
  "Elmoslem Pro App Version": "تطبيق المسلم برو الإصدار",
  ...
  ///
  "Elmoslem Pro App | Rate the app": 'تطبيق المسلم برو: تقييم التطبيق',
  "notes": "ملاحظات",
  ...
  "Elmoslem Pro App | Chat": 'تطبيق المسلم برو: نداء',

  "Elmoslem Pro App | Misspelled": 'تطبيق المسلم برو: خطأ إملائي',
