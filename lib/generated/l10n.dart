...
class S {
  ...
  /// `Elmoslem Pro App Version`
  String get ElmoslemProAppVersion {
    return Intl.message(
      'Elmoslem Pro App Version',
      name: 'ElmoslemProAppVersion',
      desc: '',
      args: [],
    );
  }
